            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context)!.followersRequired,
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w500,
                      color: Colors.black87,
                  ...
                  Text(AppLocalizations.of(context)!.includeJobsOutsideYourCity,
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w500,
                      color: Colors.black87,
                  ...
                  const SizedBox(height: 24),
                  Text(AppLocalizations.of(context)!.payRange,
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w500,
                      color: Colors.black87,
