...
import 'package:bombay_casting/utils/legal_links.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          ExpansionTile(
            title: const Text('Related to my creator profile', style: _titleStyle),
          ...
          ExpansionTile(
            title: const Text('Related to jobs', style: _titleStyle),
          ...
          const Divider(height: 1, thickness: 0.5, color: Colors.black12),
          ExpansionTile(
            title: const Text('Payment related', style: _titleStyle),
          ...
          const Divider(height: 1, thickness: 0.5, color: Colors.black12),
          ExpansionTile(
            title: const Text('App policies', style: _titleStyle),
